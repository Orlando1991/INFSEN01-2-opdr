...
namespace GUIapp
{
				...
				default:
					{
						...
						guiManager.elements.Add(buttonConstructor.Instantiate("Click me", new Point(0, 100), 10, Colour.Black, 100, 30,
																	...
																	{
																		guiManager.elements = new List<GuiElement>();
																		guiManager.elements.Add(buttonConstructor.Instantiate("Exit5", new Point(0, 0), 10, Colour.Black, 100, 30,
																	() =>
																			  {
																				  exit();
																			  }
	...
	public abstract class GuiDecorator : GuiElement//MISSING CODE
	{
	...
	public class Button : GuiDecorator
	{
		...
		//MISSING CODE
		{
			...
			this.height = height;
			this.color = color;
			label = new Label(this.text, this.top_left_corner, this.size, this.color);
		}
		public override void Draw(DrawVisitor visitor)
		{
