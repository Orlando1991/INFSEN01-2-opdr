...
namespace GUIapp
{
                ...
                case "1":
                    {
                        ...
                        guiManager.elements.Add(labelConstructor.Instantiate("Hi Eldin!", new Point(0, 0), 10, Colour.Black));
                        guiManager.elements.Add(buttonConstructor.Instantiate("Click me", new Point(0, 100), 10, Colour.Black, 100, 30,
                                                                    () => {
                                                                        guiManager.elements = new List<GuiElement>();
                                                                        guiManager.elements.Add(buttonConstructor.Instantiate("Exit4", new Point(0, 0), 10, Colour.Black, 100, 30,
                                                                    () => {
                                                                                  exit();
                                                                              }
                                                                    ));
    ...
    public class LabelConstructor : GuiElementCreator //MISSING CODE
    {
        public override GuiElement Instantiate(string text, Point top_left_corner, int size, Colour color)
        {
